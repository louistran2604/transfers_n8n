...
9. A post may contain more than one transfer report. Each item must still contain every schema field. Confidence reflects only how clearly the post supports that extracted report.
