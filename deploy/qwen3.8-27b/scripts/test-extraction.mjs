...
import { canonicalizeReport, loadEntityAliases, validateExtractionResponse } from '../../../workflow/lib.mjs';
...
const schemaPath = new URL('../../../workflow/extraction-response-schema.json', import.meta.url);
const promptPath = new URL('../../../workflow/extraction-system-prompt.md', import.meta.url);
